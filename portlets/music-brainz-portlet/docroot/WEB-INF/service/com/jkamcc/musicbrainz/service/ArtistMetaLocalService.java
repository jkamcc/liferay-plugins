...
/**
 * Provides the local service interface for ArtistMeta. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Juan Carrillo
 * @see ArtistMetaLocalServiceUtil
...
public interface ArtistMetaLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ArtistMetaLocalServiceUtil} to access the artist meta local service. Add custom service methods to {@link com.jkamcc.musicbrainz.service.impl.ArtistMetaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
